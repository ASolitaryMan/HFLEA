...
def create_tsv(
    ...
    Args:
        ...
        valid_percent (float, optional): The percentage of data for validation. (Default: 0.2)
        seed (int): The seed for randomly selecting the validation files.
        extension (str, optional): The extension of audio files. (Default: ``wav``)
...
if __name__ == "__main__":
    #验证能否生成tsv文件
    create_tsv(
        root_dir="/home/lqf/workspace/icassp2023/myhubert/audio",
        out_dir="/home/lqf/workspace/icassp2023/myhubert/",
        dataset="IEMOCAP",
        seed=1337
    )
    pass
